...
"""
    ...
    script_body = f"""# Auto-generated by LUMEN reminder — do not edit
...
def _schedule_mac(target_dt: datetime, task_name: str,
    ...
    label     = f"com.lumen.reminder.{task_name}"
...
def reminder(
    ...
    task_name  = f"LUMENReminder_{target_dt.strftime('%Y%m%d_%H%M%S')}"
